...
//---------------------------------------------------------------------------------
	...
	REG_BG0CNT = TEXTBG_SIZE_512x256 | BG_MAP_BASE(0) | BG_TILE_BASE(2) | BG_PRIORITY(2);
	REG_BG1CNT = TEXTBG_SIZE_512x256 | BG_MAP_BASE(2) | BG_TILE_BASE(1) | BG_PRIORITY(2) | BG_256_COLOR;
